...
function start(client) {
    client.onMessage((message) => __awaiter(this, void 0, void 0, function* () {
        if (message.body === 'test1' && message.isGroupMsg === false) {
            yield client.sendText(message.from, 'Teste whatsapp boot DM');
        }
        if (message.body === 'oi' || message.body === 'olá' || message.body === 'oii' && message.isGroupMsg === false) {
            yield client.sendText(message.from, 'Oi, tudo bem? Sou um bot de teste!');
        }
    }));
}
app.post("/type-number-verification", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.status(200).json();
}));
const PORT = 8945;
app.listen(PORT, () => {
